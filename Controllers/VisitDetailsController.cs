...
namespace md753815MIS4200spring.Controllers
{
    public class VisitDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "visitDetailId,price,visitId")] VisitDetail visitDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "visitDetailId,price,visitId")] VisitDetail visitDetail)
        {
            if (ModelState.IsValid)
            {
